package org.examples.assignment;
...
public class FinalProject {
    ...
    public static void main(String[] args) {
        ...
        String TotalAmount = driver.findElement(By.xpath("(//table[@class" +
                "='table table-bordered'])[3]//tr[2]/td[2]")).getText();
        if(TotalAmount.equals("$3000.00")){
